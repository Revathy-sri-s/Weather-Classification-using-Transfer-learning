...
APPLICATION
        ...
        Our application speaks more on classification of weather based on the given input ans seasons
        It makes the user more userfriendly,precise and required result is produced.